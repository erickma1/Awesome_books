...
**[Awesome_Books]** is a website that allows users to add and remove books from a list.
...
- **[Add button to add a new book to the collection]**
- **[Includes a remove button to remove a book from the collection]**
...
```sh
cd capstone-project
git clone https://github.com/erickma1/Awesome_books/tree/awesome-books
```
...
This project is [MIT](https://github.com/erickma1/Awesome_books/blob/awesome-books/LICENSE) licensed.
